...
//Ingreso de datos
	...
	printf("Carga de un arbol, finaliza con 0.\n\n");
...
//Salida de datos		
	...
	printf("\n\nArbol IRD de menor a mayor\n\n");
	imp_arbol_rec(ar);
	printf("\n\nCantidad de n%cmeros repetidos en el ingreso: %d",163,contrep);
	printf("\n\nCantidad de n%cmeros eliminados: %d",163,conteli);	
